        ...
        <div class="col-md-8">
            ...
            <div class="mb-3">
                ...
                <p class="text-muted mb-0">
                    Sampaikan aspirasi dengan jelas dan lengkap agar mudah diproses.
                </p>
            </div>
                    ...
                    <form method="POST"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description"
                                      ...
                                      placeholder="Jelaskan kronologi, lokasi, dan harapan solusi secara rinci..."
...
{{-- Optional: konfirmasi SweetAlert2 khusus untuk submit (bukan draft) --}}
@push('scripts')
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        form.addEventListener('click', function (e) {
            ...
            if (action !== 'submit') return; // draft langsung kirim
